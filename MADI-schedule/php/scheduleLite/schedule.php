...
<head>
    ...
    <link rel="stylesheet" href="../../assets/css/scheduleLite/scheduleLite.css">
</head>
<body>
...
<div class="classBlock">
    <p>Сейчас у вас выбрано:
        <?php
        $select = strval($_COOKIE['class']);
    ...
    <form>
        ...
        <button type="button" class="btnChangeClassInScheduleLite">Сохранить</button>
        <p class="msg none">Lorem ipsum dolor sit amet.</p>
    </form>
</div>

<form class="logoutForm">
    <a href="../../vendor/scheduleLite/logout.php" class="logout varInProfileInfo">Выход</a>
</form>

<script src="../../assets/js/jquery-3.7.1.min.js"></script>
<script src="../../assets/js/scheduleLite/changeClass.js"></script>
